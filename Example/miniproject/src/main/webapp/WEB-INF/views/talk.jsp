...
<%-- 	<button onclick="displayDiv(1);">글쓰기</button>
	
	<form method = "post" action = "/miniproject/talk/update" id="columnview" style="display: none">
		...
		<input type="button" value="삭제" onclick="location.href='/miniproject/talk/delete?talkid=${column.id}'">
	</form> --%>
	<div>
