...
<%@ page import="vo.ProdVO, java.util.List" %>
<!DOCTYPE html>
<!-- <html lang="en"> -->
...
<%--   	<%
	 ...
	 <div class="col-1-4">
    	<div class="show show-first">
      	<img src="/miniproject/resources/img/<%=vo.getProdID() %>_1.jpg" width="300px" height="300px" />
      
	      <div class="mask">
        	<h2><%=vo.getPname() %></h2>
        	<p class="price"><%=vo.getPname() %><br><%=vo.getProdID() %></p>
        	<a href="uploadboard//NT950QCG-X716A" class="more">More info</a>
      	</div>
    	</div>
  	</div>
