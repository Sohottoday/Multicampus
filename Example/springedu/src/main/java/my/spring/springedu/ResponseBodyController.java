...
public class ResponseBodyController {
	@RequestMapping(value = "/body/text/{id}", produces = "text/plain; charset=utf-8")	//responseBody를 진행할때 produces는 필수
	@ResponseBody		//view를 거치지 않고 컨트롤러가 직접 클라이언트한테 응답바디를 구성하겠다.
	public String getByIdInTEXT(@PathVariable String id) {	//PathVariable 를 입력하지 않으면 id를 쿼리문자열에서 찾게됨.
